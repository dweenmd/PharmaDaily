...
} from "@/features/customers/components/customer-management-view";
...
export default async function CustomersPage() {
  ...
  const mappedCustomers: CustomerCRMItem[] = dbCustomers.map((c) => {
  ...
  const hasRahim = mappedCustomers.some((c) =>
    c.name.toLowerCase().includes("rahim") && c.phone === "017XXXXXXXX",
  );
